        ...
        if agent_configs_data:
            for ac in agent_configs_data:
                ...
                ac_values = {
                    ...
                    'coding_test_case_mode': ac.get('coding_test_case_mode') or ac.get('codingTestCaseMode') or 'ai',
                    ...
                    'mcq_question_mode': ac.get('mcq_question_mode') or ac.get('mcqQuestionMode') or 'ai',
