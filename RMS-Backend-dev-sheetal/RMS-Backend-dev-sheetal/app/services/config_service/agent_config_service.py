    ...
    async def update_job_agent_config(
        ...
        for round_data in rounds_data:
            ...
            config_payload = {
                ...
                "coding_test_case_mode": getattr(round_data, "codingTestCaseMode", getattr(round_data, "coding_test_case_mode", "provided")) or "provided",
                ...
                "mcq_question_mode": getattr(round_data, "mcqQuestionMode", getattr(round_data, "mcq_question_mode", "provided")) or "provided",
        ...
        return [
            {
                ...
                "codingTestCaseMode": getattr(config, "coding_test_case_mode", "provided"),
                ...
                "mcqQuestionMode": getattr(config, "mcq_question_mode", "provided"),
