    ...
    async def _store_runtime_policy(
        ...
        *,
        ...
        policy = {
            ...
            "secureBrowserRequired": mode in {"coding_assessment", "apti_assessment"},
            "proctoringRequired": mode in {"coding_assessment", "apti_assessment"},
            "headMovementCheck": mode in {"coding_assessment", "apti_assessment"},
            "eyeFocusCheck": mode in {"coding_assessment", "apti_assessment"},
