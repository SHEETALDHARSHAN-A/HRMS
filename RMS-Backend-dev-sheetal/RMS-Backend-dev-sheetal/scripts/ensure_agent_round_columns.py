...
ALTERS = [
    ...
    "ALTER TABLE round_config ADD COLUMN IF NOT EXISTS coding_test_case_mode VARCHAR DEFAULT 'provided';",
    ...
    "ALTER TABLE round_config ADD COLUMN IF NOT EXISTS mcq_question_mode VARCHAR DEFAULT 'provided';",
